 ...
 */
    ...
    void MPU6050::setI2CBypassEnabled(int8_t state) {
    return i2c->writeBit(INT_PIN_CFG, state, 1);
    }

    int8_t MPU6050::getI2CBypassEnabled(void) {
    return i2c->readBit(INT_PIN_CFG, 1);
    }
